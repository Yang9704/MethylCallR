...
Others = data.frame(CpGid=O$Name, AddressA_ID=O$AddressA_ID, AddressB_ID = O$AddressB_ID, Infinium_Design_Type = O$Infinium_Design_Type, Color_Channel=O$Color_Channel,Chr_hg37=O$CHR, Position_hg37 = O$MAPINFO, strand_hg37=O$Strand, UCSC_RefGene_Name=O$UCSC_RefGene_Name, UCSC_RefGene_Accession=O$UCSC_RefGene_Accession, UCSC_RefGene_Group=O$UCSC_RefGene_Group, UCSC_CpG_Islands_Name=O$UCSC_CpG_Islands_Name, Relation_to_UCSC_CpG_Island=O$Relation_to_UCSC_CpG_Island, Phantom4_Enhancers=O$Phantom4_Enhancers, Phantom5_Enhancers=O$Phantom5_Enhancers, Methyl27_Loci=O$Methyl27_Loci, Methyl450_Loci=O$Methyl450_Loci, SNP_MinorAlleleFrequency=O$SNP_MinorAlleleFrequency, Random_Loci=O$Random_Loci, MFG_Change_Flagged=O$MFG_Change_Flagged)
...
Others = data.frame(CpGid=O$Name, AddressA_ID=O$AddressA_ID, AddressB_ID = O$AddressB_ID, Infinium_Design_Type = O$Infinium_Design_Type, Color_Channel=O$Color_Channel, UCSC_RefGene_Name=O$UCSC_RefGene_Name, UCSC_RefGene_Accession=O$UCSC_RefGene_Accession, UCSC_RefGene_Group=O$UCSC_RefGene_Group, UCSC_CpG_Islands_Name=O$UCSC_CpG_Islands_Name, Relation_to_UCSC_CpG_Island=O$Relation_to_UCSC_CpG_Island, Phantom5_Enhancers=O$Phantom5_Enhancers,GencodeV41_Group = O$GencodeV41_Group ,GencodeV41_Name = O$GencodeV41_Name, GencodeV41_Accession = O$GencodeV41_Accession,Regulatory_Feature_Name=O$Regulatory_Feature_Name,Regulatory_Feature_Group = O$Regulatory_Feature_Group,OpenChromatin_NAME = O$OpenChromatin_NAME,OpenChromatin_Evidence_Count = O$OpenChromatin_Evidence_Count,Methyl27_Loci=O$Methyl27_Loci, Methyl450_Loci=O$Methyl450_Loci,Methyl450_Enhancer = O$X450k_Enhancer,EPICv1_Loci=O$EPICv1_Loci ,SNP_MinorAlleleFrequency=O$SNP_MinorAlleleFrequency)
}
